...
import program.model.TechCards;
...
public class ProcessAgent extends Agent {
    ...
    protected void takeDown() {
        ...
        System.out.println("ProcessAgent " + getAID().getName() + " terminating");
    }

    public void parser() throws IOException {
        ObjectMapper objectMapper = new ObjectMapper();
        TechCards techCards = objectMapper.readValue(new File("./src/main/files/tech_cards.txt"), TechCards.class);
    }
}