...
import program.model.StocksProductsList;
...
public class WarehouseAgent extends Agent {
    ...
    protected void takeDown() {
        ...
        System.out.println("WarehouseAgent " + getAID().getName() + " terminating");
    }

    public void parser() throws IOException {
        ObjectMapper objectMapper = new ObjectMapper();
        StocksProductsList stocksProductsList = objectMapper.readValue(new File("./src/main/files/stock.txt"), StocksProductsList.class);
    }
}
